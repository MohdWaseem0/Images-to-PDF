...
import swati4star.createpdf.databinding.LayoutItemHistoryBinding;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHistoryHolder> {
    ...
    public ViewHistoryHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutItemHistoryBinding binding = LayoutItemHistoryBinding.inflate(
                LayoutInflater.from(parent.getContext()), parent, false);
        return new HistoryAdapter.ViewHistoryHolder(binding);
    }
    ...
    public class ViewHistoryHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHistoryHolder(LayoutItemHistoryBinding binding) {
            super(binding.getRoot());
            binding.getRoot().setOnClickListener(this);
            mFilename = binding.fileName;
            mOperationDate = binding.operationDate;
            mOperationType = binding.operationType;
            mOperationImage = binding.operationImage;
        }
